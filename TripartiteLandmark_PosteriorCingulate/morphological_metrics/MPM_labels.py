## Script to create maximum probability maps from labels projected into fsaverage space
## Inputs:
## argv1: subject to be left out
## argv2: subject directory of freesurfer data
## argv3: location of labels projected into fsaverage space
## argv4: list of subject ids
## argv5: project id for output 
## argv6: directory of prediction labels
## argv7: 
...
middle_frontal_label_names = np.array(['2'])
# subjects = np.genfromtxt(sys.argv[7], dtype = str) # subjects if prediction group different from input group
...
print('assembling MPMs for label(s) ', middle_frontal_label_names)
...
vertices_lh, RAS_lh = read_label('/home/despoB/jam124/Freesurfer/subjects/fsaverage/label/lh.cortex.label')
...
vertices_rh, RAS_rh = read_label('/home/despoB/jam124/Freesurfer/subjects/fsaverage/label/rh.cortex.label')
