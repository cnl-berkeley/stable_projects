...
HCP_count_disc.plot <- ggplot(HCP_count_disc, aes(x = Sulcus)) +
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0, size = 14), 
        ...
        axis.title.y = element_text(size=18, face = "bold"), # size = 20 for production figure
        axis.text.x = element_text(size = 9, face = "bold", vjust = .70), # size = 20 for production figure
        axis.text.y = element_text(size = 15, face = "bold"), # size = 20 for production figure
...
HCP_count_rep.plot <- ggplot(HCP_count_rep, aes(x = Sulcus)) +
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0, size = 14), 
        ...
        axis.text.x = element_text(size = 9, face = "bold", vjust = .70), # was 20
...
eta_sq(discovery_ratio_loc.aov) #Eta-squared
...
eta_sq(replication_ratio_loc.aov) #Eta-squared
...
eta_sq(discovery_ct_alone.aov) #Eta-squared
...
eta_sq(discovery_my_alone.aov) #Eta-squared
...
eta_sq(replication_ct_alone.aov) #Eta-squared
...
eta_sq(replication_my_alone.aov) #Eta-squared
...
ctmy_rh.plot <- ggplot(HCP_tot_analysis_rh, aes(x = label_dataset, fill = label_dataset)) + 
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0, size = 14), 
          ...
          plot.caption = element_text(size = 12, hjust = 1),
          axis.title.x = element_text(size=18, face = "bold", vjust = .9),
          axis.title.y = element_text(size=18, face = "bold", vjust = .9), # size = 20 for production figure
          axis.title.y.right = element_text(size=20, face = "bold", vjust = 1),
          axis.text.x = element_text(size = 11, face = "bold", vjust = .70), # size = 15 for production figure
          axis.text.y = element_text(size = 11, face = "bold"), # size = 20 for production figure
          legend.title = element_text(size=14), 
          legend.text = element_text(size=12),
          strip.text.x = element_text(size = 18, face = "bold"), # size = 20 for production figure
          strip.background = element_blank(),
          strip.placement = "outside",
          axis.line = element_line(colour = "black", linetype = "solid", lineend = "round")) +
  facet_wrap( ~ label, strip.position = "bottom", scales = "free_x", ncol = 4)
...
* 3-way (network x sulcal label x hemi) ANOVA to test for differences in overlap (DICE coefficient; see Methods)
...
# ANOVA
network2.aov <- aov(dice_coeff ~ hemi*label_name*network_name, data = six_networks_ifrms_spls_discovery)
summary(network2.aov) #p-values
eta_sq(network2.aov) #Eta-squared

# Post hoc tests
network_aov.i1 <- emmeans::emmeans(network2.aov, ~ label_name | network_name)
emmeans::contrast(network_aov.i1, method='pairwise')

network_aov.i2 <- emmeans::emmeans(network2.aov, ~ hemi | label_name | network_name)
...
# ANOVA
network2_rep.aov <- aov(dice_coeff ~ hemi*label_name*network_name, data = six_networks_ifrms_spls_replication)
summary(network2_rep.aov) #p-values
eta_sq(network2_rep.aov) #Eta-squared

# Post hoc tests
network_aov_rep.i1 <- emmeans::emmeans(network2_rep.aov, ~ label_name | network_name)
emmeans::contrast(network_aov_rep.i1, method='pairwise')

network_aov_rep.i2 <- emmeans::emmeans(network2_rep.aov, ~ hemi | label_name | network_name)
...
cohens_d(data = ifrms_predicts.both,
         formula = dice ~ method, 
         paired= T)
```
...
prediction_comp.plot <- ggplot() +
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0, size = 14), 
        ...
        axis.title.x = element_text(size=20, face = "bold", vjust = .70),
        axis.title.y = element_text(size=20, face = "bold"),
        axis.text.x = element_text(size = 16, face = "bold", vjust = .70),
        axis.text.y = element_text(size = 20, face = "bold"),
        legend.title = element_text(size=14), 
        legend.text = element_text(size=12),
        strip.text.x = element_text(size = 10),
...
# ANOVA
prcus_network.aov <- aov(dice_coeff ~ hemi*label_name*network_name, data = prcus_dice_disc)
summary(prcus_network.aov) #p-values
eta_sq(prcus_network.aov) #Eta-squared

# Post hoc test
network_aov.i1 <- emmeans::emmeans(prcus_network.aov, ~ label_name | network_name)
emmeans::contrast(network_aov.i1, method='pairwise')
```
...
# Anova
prcus_network_rep.aov <- aov(dice_coeff ~ hemi*label_name*network_name, data = prcus_dice_repl)
summary(prcus_network_rep.aov) #p-values
eta_sq(prcus_network_rep.aov) #Eta-squared

# Post hoc test
prcus_network_rep_aov.i1 <- emmeans::emmeans(prcus_network_rep.aov, ~ label_name | network_name)
...
## hcpC rh ~ nora rh
cor.test(c(as.matrix(hcpC_tert_lh_mat)), c(as.matrix(nora_tert_rh_mat)))

## hcpC lh ~ adni lh
cor.test(c(as.matrix(hcpC_tert_lh_mat)), c(as.matrix(adni_tert_lh_mat)))

## hcpC rh ~ adni rh
cor.test(c(as.matrix(hcpC_tert_lh_mat)), c(as.matrix(adni_tert_rh_mat)))
...
tab_source_note(md("*Note.* This table illustrates the incident rates of the 8-11 definable PMC sulci in the *replication* young adult sample (N = 36 participants). The incidence rate of each sulcus (posterior to anterior) is provided in number and percent for both the left (LH) and right hemispheres (RH). The abbreviations used are as follows: anterior precuneal sulcus (*prcus-a*); intermediate precuneal sulcus (*prcus-i*); inframarginal sulcus (*ifrms*); marginal ramus of the cingulate sulcus (*mcgs*); parieto-occipital sulcus (*pos*); posterior intracingulate sulcus (*icgs-p*); posterior precuneal sulcus (*prcus-p*); precuneal limiting sulcus (*prculs*); splenial sulcus (*spls*); subsplenial sulcus (*sspls*); superior parietal sulcus (*sps*).")) %>%
  tab_options(table.font.size = 20,
    heading.title.font.size = 20,
    heading.subtitle.font.size = 20,
    heading.align = "left",
...
tab_source_note(md("*Note.* This table illustrates the incident rates of the 8-11 definable PMC sulci in the juvenile sample (N = 72 participants). The incidence rate of each sulcus (posterior to anterior) is provided in number and percent for both the left (LH) and right hemispheres (RH). The abbreviations used are as follows: anterior precuneal sulcus (*prcus-a*); intermediate precuneal sulcus (*prcus-i*); inframarginal sulcus (*ifrms*); marginal ramus of the cingulate sulcus (*mcgs*); parieto-occipital sulcus (*pos*); posterior intracingulate sulcus (*icgs-p*); posterior precuneal sulcus (*prcus-p*); precuneal limiting sulcus (*prculs*); splenial sulcus (*spls*); subsplenial sulcus (*sspls*); superior parietal sulcus (*sps*).")) %>%
  tab_options(table.font.size = 20,
    heading.title.font.size = 20,
    heading.subtitle.font.size = 20,
    heading.align = "left",
...
tab_source_note(md("*Note.* This table illustrates the incident rates of the 8-11 definable PMC sulci in the healhty older adult sample (N = 72 participants). The incidence rate of each sulcus (posterior to anterior) is provided in number and percent for both the left (LH) and right hemispheres (RH). The abbreviations used are as follows: anterior precuneal sulcus (*prcus-a*); intermediate precuneal sulcus (*prcus-i*); inframarginal sulcus (*ifrms*); marginal ramus of the cingulate sulcus (*mcgs*); parieto-occipital sulcus (*pos*); posterior intracingulate sulcus (*icgs-p*); posterior precuneal sulcus (*prcus-p*); precuneal limiting sulcus (*prculs*); splenial sulcus (*spls*); subsplenial sulcus (*sspls*); superior parietal sulcus (*sps*).")) %>%
  tab_options(table.font.size = 20,
    heading.title.font.size = 20,
    heading.subtitle.font.size = 20,
    heading.align = "left",
