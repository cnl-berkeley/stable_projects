...
```{r, warning = FALSE}
# Discovery dataset
chi_discovery <- read.csv("~/Desktop/DropBox/cnl/stable_projects/TripartiteLandmark_PosteriorCingulate/RMD_csvs/PCC_chisqrd_discovery.csv")
...
```{r, warning = FALSE}
# Dataset - all
HCP_all_sulci_depth <- read.csv("~/Desktop/DropBox/cnl/stable_projects/TripartiteLandmark_PosteriorCingulate/RMD_csvs/HCP_all_sulci_depth.csv")
...
PCC_depth_disc.plot
 ...
 # ggplot2::ggsave(filename = "~/Desktop/PCC_depth_disc_plot.png",
...
PCC_depth_rep.plot
 ...
 # ggplot2::ggsave(filename = "~/Desktop/PCC_depth_rep_plot.png",
 #                 plot = PCC_depth_rep.plot,
 #                 device = "png",
 #                 width = 10,
 #                 height = 5,
 #                 units = "in",
...
```{r, warning = FALSE}
# Dataset - all
HCP_tot_analysis <- read.csv("~/Desktop/DropBox/cnl/stable_projects/TripartiteLandmark_PosteriorCingulate/RMD_csvs/HCP_PCC_ctmy_analysis.csv")
HCP_tot_analysis.ifrms.rh <- HCP_tot_analysis %>% subset(hemi == "rh" & label == "ifrms")

summary(lm(myelin ~ sulcal_depth_max * hemi, HCP_tot_analysis))
...
#### Figure 4b: C/M ratio of PCC sulci
```{r, warning = FALSE}
# Feature for plot
...
ctmy_lh.plot <- ggplot(HCP_tot_analysis_lh, aes(x = label_dataset, fill = label_dataset)) + 
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0, size = 14), 
          ...
          axis.text.x = element_text(size = 12, face = "bold", vjust = .70), # was 16
          axis.text.y = element_text(size = 12, face = "bold"), # was 20
          legend.title = element_text(size=14), 
          legend.text = element_text(size=12),
...
# ggplot2::ggsave(filename = "~/Desktop/ctmy_lh_plot.png",
#                  plot = ctmy_lh.plot,
#                  device = "png",
#                  width = 12,
#                  height = 5,
...
# ggplot2::ggsave(filename = "~/Desktop/ctmy_rh_plot.png",
#                  plot = ctmy_rh.plot,
#                  device = "png",
#                  width = 12,
#                  height = 5,
...
```{r, warning = FALSE}
# Dataset - all
networks_dice_ifrms_spls <- read.csv("~/Desktop/DropBox/cnl/stable_projects/TripartiteLandmark_PosteriorCingulate/RMD_csvs/networks_dice_ifrms_spls.csv")
...
#### Figure 5b: Mean *ifrms* and *spls* connectivity fingerprints - discovery
```{r, warning = FALSE}
...
network_dice_discovery.plot <- ggplot() +  
  ...
  scale_fill_manual(limits = c("ifrms.lh", "ifrms.rh", "spls.lh", "spls.rh"), 
                    labels = c("ifrms lh", "ifrms rh", "spls lh", "spls rh"),
                    values = c("#969696", "#cccccc", "#238b45", "#74c476")) +
  
  scale_color_manual(limits = c("ifrms.lh", "ifrms.rh", "spls.lh", "spls.rh"), 
                     labels = c("ifrms lh", "ifrms rh", "spls lh", "spls rh"),
                     values = c("#252525", "#404040", "#238b45", "#74c476")) + 
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0, size = 14), 
        ...
        axis.title.x = element_text(size = 0, face = "bold"), # was 12
        axis.title.y = element_text(size = 0, face = "bold"), # was 12
        axis.text.x = element_text(size = 13.5, face = "bold", color = "black", vjust = .50), # was 5
        axis.text.y = element_text(size = 0, face = "bold"), # was 10
        strip.text.x = element_text(size = 0, face = "bold"), # was 12
        legend.title = element_text(size=0, face = "bold"), # was 10
        legend.text = element_text(size=0), # was 8
        legend.position="bottom", 
...
# ggplot2::ggsave(filename = "~/Desktop/network_dice_discovery_plot.png",
...
network_dice_replication.plot <- ggplot() +  
  geom_polygon(data = ifrms_networks_rep.se.lh.l, 
               aes(x = network_name, y = dice_coefficient, 
                   group = label_hemi, color = label_hemi), 
               fill = NA,
               linetype = 2, size = .4) + 
  ...
  geom_polygon(data = ifrms_networks_rep.avg.lh, 
               aes(x = network_name, y = dice_coefficient, 
                   fill = label_hemi, group = label_hemi, 
                   color = label_hemi), 
               size = .9, alpha = .3) +
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0, size = 14), 
        ...
        axis.title.x = element_text(size = 0, face = "bold"), # was 12
        axis.title.y = element_text(size = 0, face = "bold"), # was 12
        axis.text.x = element_text(size = 13.5, face = "bold", color = "black", vjust = .50), # was 12
        axis.text.y = element_text(size = 0, face = "bold"), # was 12
        strip.text.x = element_text(size = 0, face = "bold"), # was 12
        legend.title = element_text(size=0, face = "bold"), # was 14
        legend.text = element_text(size=0), # was 12
        legend.position = "bottom",
        axis.line = element_line(colour = "black", 
                                 size = 0, linetype = "solid", lineend = "round"),
        panel.grid.minor = element_line(size = 0.5, color = "gray"), 
...
ggplot2::ggsave(filename = "~/Desktop/network_dice_replication_plot.png",
...
#### Figure 5c: Four individual subjects' radar plots
```{r, warning = FALSE}
...
overlap_100206.plot <- ggplot() +  
  ...
  label_hemi, color = label_hemi), size = .9, alpha = .3) +
  geom_point(data = dice.100206.lh, aes(x = network_name, y = dice_coeff,
                                        color = label_hemi), size = 2) +
  
  geom_polygon(data = dice.100206.rh , aes(x = network_name, y = dice_coeff, fill = label_hemi,
  group = label_hemi, color = label_hemi), size = .9, alpha = .3) +
  geom_point(data = dice.100206.rh, aes(x = network_name, y = dice_coeff,
              color = label_hemi),
             size = 2) +
  coord_radar(start = -pi/2) +
  labs(x = "Network Name",
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0, size = 14), 
        ...
        axis.title.x = element_text(size = 0, face = "bold"), # was 12
        axis.title.y = element_text(size = 0, face = "bold"), # was 12
        axis.text.x = element_text(size = 11, face = "bold", color = "black", vjust = .50), # was 8
        axis.text.y = element_text(size = 0, face = "bold"), # was 12
        strip.text.y = element_text(size = 0, face = "bold"), # was 12
        legend.title = element_text(size=0, face = "bold"), # was 14
        legend.text = element_text(size=0), # was 12
        legend.position = "bottom",
        axis.line = element_line(colour = "black", 
...
# ggplot2::ggsave(filename = "~/Desktop/overlap_100206_plot.png",
...
# ggplot2::ggsave(filename = "~/Desktop/overlap_101107_plot.png",
...
# ggplot2::ggsave(filename = "~/Desktop/overlap_109830_plot.png",
...
# ggplot2::ggsave(filename = "~/Desktop/overlap_214019_plot.png",
...
#### Figure 6b: Locational coupling between the *ifrms* and CCN-b network
```{r, warning = FALSE}
# Discovery Sample
...
#### Figure 6c: Locational coupling between the *ifrms* and CCN-c network
```{r, warning = FALSE}
# Discovery Sample
...
#### Figure 7c: Normalized depth comparison
```{r, warning = FALSE}
...
#### Figure 7d: Normalized thickness comparison
```{r, warning = FALSE}
# Means for plot
...
```{r, warning = FALSE}
# CNN Dataset - all
pmc_nn_predicts <- read.csv("~/Desktop/DropBox/cnl/stable_projects/TripartiteLandmark_PosteriorCingulate/RMD_csvs/pmc_cnn_predicts.csv")

# CNN Dataset - ifrms only
pmc_nn_predicts.ifrms <- pmc_nn_predicts %>% subset(sulci == "ifrms") %>% select(-c("X", "type"))

# CBA Dataset 
ifrms_cba_predicts.ifrms <- read.csv("~/Desktop/DropBox/cnl/stable_projects/TripartiteLandmark_PosteriorCingulate/RMD_csvs/HCP_dice_coefficients_all_72_predicts.csv")
...
### Figure 8a-b: Evaluation of predictive labeling methodologies
```{r, warning = FALSE}
# Figure 7a: Bar plot 
...
# ggplot2::ggsave(filename = "~/Desktop/prediction_comp_plot.png",
...
# ggplot2::ggsave(filename = "~/Desktop/prediction_dist_plot.png",
...
## Supplementary Figure 2: Incidence rates of all 11 sulci
```{r, warning = FALSE}
...
## Supplementary Figure 2: Depth of all 11 sulci 
...
```{r, warning = FALSE}
# Dataset - all
HCP_all_morphology <- read.csv("~/Desktop/DropBox/cnl/stable_projects/TripartiteLandmark_PosteriorCingulate/RMD_csvs/HCP_all_morphology.csv")
...
all_sulc_depth_disc.plot <- ggplot() +
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0, size = 14), 
        ...
        axis.title.x = element_text(size=20, face = "bold", vjust = .70),
        axis.title.y = element_text(size=20, face = "bold"),
        axis.text.x = element_text(size = 16, face = "bold", vjust = .70), # was 8
        axis.text.y = element_text(size = 20, face = "bold"),
        legend.title = element_text(size=14), 
        legend.text = element_text(size=12),
        strip.text.x = element_text(size = 10), 
...
# ggplot2::ggsave(filename = "~/Desktop/all_sulc_depth_disc_plot.png",
...
# ggplot2::ggsave(filename = "~/Desktop/all_sulc_depth_repl_plot.png",
...
## Supplementary Figure 2: Surface area of PCC and PrC sulci 
...
ggplot2::ggsave(filename = "~/Desktop/HCP_all_morphology_disc_sa_tert_plot.png",
...
# ggplot2::ggsave(filename = "~/Desktop/HCP_all_morphology_disc_sa_plot.png",
...
# ggplot2::ggsave(filename = "~/Desktop/HCP_all_morphology_rep_sa_plot.png",
...
## Supplementary Figure 3: Correlation matrices for sulcal intersections of the discovery and replication sample shallow PCC sulci
```{r}
# Make matrices
...
## Supplementary Figure 6: C/M with all 11 sulci
```{r, warning = FALSE}
# Dataset
HCP_figure3_supplement <- read.csv("~/Desktop/DropBox/cnl/stable_projects/TripartiteLandmark_PosteriorCingulate/RMD_csvs/HCP_figure3_supplement.csv")
...
ctmy_11.plot <- ggplot(HCP_figure3_supplement_lh, aes(x = label_dataset, fill = label_dataset)) + 
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0, size = 14), 
          ...
          axis.title.y.right = element_text(size=20, face = "bold", vjust = 1),
          axis.text.x = element_text(size = 12, face = "bold", vjust = .70), # was 12
          axis.text.y = element_text(size = 20, face = "bold"), # was 20
          legend.title = element_text(size=14), 
          legend.text = element_text(size=12),
          strip.text.x = element_text(size = 16, face = "bold"), # was 16
          strip.background = element_blank(),
          strip.placement = "outside",
          axis.line = element_line(colour = "black", linetype = "solid", lineend = "round")) +
...
# ggplot2::ggsave(filename = "~/Desktop/ctmy_11_lh_plot.png",
#                 plot = ctmy_11.plot,
#                 device = "png",
#                 width = 12,
#                 height = 5,
...
# ggplot2::ggsave(filename = "~/Desktop/ctmy_11_rh_plot.png",
...
## Supplementary Figure 7: Cortical thickness and myelination of PCC sulci shown separately
```{r, warning = FALSE}
...
## Supplementary Figure 8: Individual subject fingerprints - discovery
```{r, warning=FALSE}
# Dataset
...
all_conn_fp_disc.plot <- ggplot() +  
  geom_polygon(data = networks_ifrms_spls_discovery.2, 
               aes(x = network_name, y = dice_coeff, fill = label_hemi, group = label_hemi, 
                   color = label_hemi),
               size = .5,
               alpha = .3) +
  geom_point(data = networks_ifrms_spls_discovery.2, aes(x = network_name, y = dice_coeff, 
                                                         color = label_hemi),
             size = 1, alpha = 1) + 
  ...
  scale_color_manual(limits = c("ifrms.lh", "ifrms.rh", "spls.lh", "spls.rh"), 
                     labels = c("ifrms lh", "ifrms rh", "spls lh", "spls rh"),
                     values = c("#252525", "#969696", "#238b45", "#74c476")) + 
  theme_minimal() +
  theme(plot.title = element_text(face = "bold", hjust = 0, size = 14), 
        plot.subtitle = element_text(hjust = 0, size = 14),
        plot.caption = element_text(size = 12),
        ...
        axis.text.x = element_text(size = 4.5, face = "bold", color = "black", vjust = .50),
...
# ggplot2::ggsave(filename = "~/Desktop/all_conn_fp_disc_plot.png",
...
## Supplementary Figure 10: Individual subject fingerprints - replication
```{r,warning=FALSE}
# Dataset
...
# ggplot2::ggsave(filename = "~/Desktop/all_conn_fp_repl_plot.png",
...
## Supplementary Figure 11: Three *prcus* connectivity fingerprints
* 3-way (network x sulcal label x hemi) repeated measures ANOVA to test for differences in overlap (DICE coefficient; see Methods)
...
## Supplementary Figure 13: Mean fingerprints for *ifrms* and *spls* in MSC
```{r}
msc_networks <- read.csv("~/Desktop/DropBox/cnl/stable_projects/TripartiteLandmark_PosteriorCingulate/RMD_csvs/MSC_ifrms_spls_networks.csv")
msc_networks$label_name <- gsub("2", "ifrms", msc_networks$label_name)
msc_networks$label_name <- gsub("sbps", "spls", msc_networks$label_name)

# anova
network_msc.rmaov <- aov(dice_coeff ~ hemi*label_name*network_name + 
                           Error(TRG_sub/(hemi*label_name*network_name)), 
                         data = msc_networks)

# table
rstatix::anova_summary(network_msc.rmaov, effect.size = "ges") #Eta-squared

# Post hoc tests
network_msc_aov.i1 <- emmeans::emmeans(network_msc.rmaov, ~ label_name | network_name)
emmeans::contrast(network_msc_aov.i1, method='pairwise')
...
# ifrms
msc_ifrms <- msc_networks %>% subset(label_name == "ifrms")

msc_ifrms$network_name <- gsub("Default_PMC", "Default", msc_ifrms$network_name)
msc_ifrms$network_name <- gsub("Cing_Operc_PMC", "Cing Operc", msc_ifrms$network_name)
msc_ifrms$network_name <- gsub("Context_PMC", "Context", msc_ifrms$network_name)
msc_ifrms$network_name <- gsub("Fronto_Par_PMC", "Fronto Par", msc_ifrms$network_name)
msc_ifrms$network_name <- gsub("Par_Memory_PMC", "Par Memory", msc_ifrms$network_name)
msc_ifrms$network_name <- gsub("Salience_PMC", "Salience", msc_ifrms$network_name)

msc_ifrms.lh <- msc_ifrms %>% subset(hemi == 'lh')
msc_ifrms.rh <- msc_ifrms %>% subset(hemi == 'rh')

# Get mean values for network-sulcus overlap 
msc_ifrms.avg <- msc_ifrms %>% 
  group_by(network_name, hemi, label_name) %>% 
  summarise(dice_coefficient = mean(dice_coeff))

# Rename dfs and add "ifrms.?h" column for color coding
msc_ifrms.avg.lh <- msc_ifrms.avg %>% subset(hemi == 'lh')
msc_ifrms.avg.lh ['label_hemi']='ifrms.lh'

msc_ifrms.avg.rh <- msc_ifrms.avg %>% subset(hemi == 'rh')
msc_ifrms.avg.rh ['label_hemi']='ifrms.rh'

# Std error calculation for plot
msc_ifrms.se <- msc_ifrms %>% 
  group_by(network_name, hemi) %>%
  summarise(n=n(), 
            sd=sd(dice_coeff), 
            se=sd/sqrt(n))

msc_ifrms.se.lh <- msc_ifrms.se %>% subset(hemi %in% c('lh')) 
msc_ifrms.se.rh <- msc_ifrms.se %>% subset(hemi %in% c('rh')) 
names(msc_ifrms.se.lh)[names(msc_ifrms.se.lh) == 'dice_coeff'] <- "se"
names(msc_ifrms.se.rh)[names(msc_ifrms.se.rh) == 'dice_coeff'] <- "se"

msc_ifrms.se.lh = msc_ifrms.se.lh %>% subset(select = -c(hemi))
msc_ifrms.se.rh = msc_ifrms.se.rh %>% subset(select = -c(hemi))

# Merge together + get upper and lower bounds
msc_ifrms.se.lh <- merge(msc_ifrms.se.lh, msc_ifrms.avg.lh,
                          by=c("network_name"))
msc_ifrms.se.rh <- merge(msc_ifrms.se.rh, msc_ifrms.avg.rh,
                          by=c("network_name"))

msc_ifrms.se.lh <- msc_ifrms.se.lh %>% 
  group_by(network_name) %>%
  mutate(upper = dice_coefficient + se, 
         lower = dice_coefficient - se)

msc_ifrms.se.rh <- msc_ifrms.se.rh %>% 
  group_by(network_name) %>%
  mutate(upper = dice_coefficient + se, 
         lower = dice_coefficient - se)

msc_ifrms.se.lh.u <- msc_ifrms.se.lh %>% subset(select = -c(lower, dice_coefficient))
names(msc_ifrms.se.lh.u)[names(msc_ifrms.se.lh.u) == 'upper'] <- "dice_coefficient"
msc_ifrms.se.lh.l <- msc_ifrms.se.lh %>% subset(select = -c(upper, dice_coefficient))
names(msc_ifrms.se.lh.l)[names(msc_ifrms.se.lh.l) == 'lower'] <- "dice_coefficient"

msc_ifrms.se.rh.u <- msc_ifrms.se.rh %>% subset(select = -c(lower, dice_coefficient))
names(msc_ifrms.se.rh.u)[names(msc_ifrms.se.rh.u) == 'upper'] <- "dice_coefficient"
msc_ifrms.se.rh.l <- msc_ifrms.se.rh %>% subset(select = -c(upper, dice_coefficient ))
names(msc_ifrms.se.rh.l)[names(msc_ifrms.se.rh.l) == 'lower'] <- "dice_coefficient"

# More renaming for plot aesthetics 
msc_ifrms.avg.lh$hemi <- gsub("lh", "Left Hemisphere", msc_ifrms.avg.lh$hemi)
msc_ifrms.avg.rh$hemi <- gsub("rh", "Right Hemisphere", msc_ifrms.avg.rh$hemi)
msc_ifrms.se.lh.l$hemi <- gsub("lh", "Left Hemisphere", msc_ifrms.se.lh.l$hemi)
msc_ifrms.se.lh.u$hemi <- gsub("lh", "Left Hemisphere", msc_ifrms.se.lh.u$hemi)
msc_ifrms.se.rh.l$hemi <- gsub("rh", "Right Hemisphere", msc_ifrms.se.rh.l$hemi)
msc_ifrms.se.rh.u$hemi <- gsub("rh", "Right Hemisphere", msc_ifrms.se.rh.u$hemi)

# spls
msc_spls <- msc_networks %>% subset(label_name == "spls")

msc_spls$network_name <- gsub("Default_PMC", "Default", msc_spls$network_name)
msc_spls$network_name <- gsub("Cing_Operc_PMC", "Cing Operc", msc_spls$network_name)
msc_spls$network_name <- gsub("Context_PMC", "Context", msc_spls$network_name)
msc_spls$network_name <- gsub("Fronto_Par_PMC", "Fronto Par", msc_spls$network_name)
msc_spls$network_name <- gsub("Par_Memory_PMC", "Par Memory", msc_spls$network_name)
msc_spls$network_name <- gsub("Salience_PMC", "Salience", msc_spls$network_name)

msc_spls.lh <- msc_spls %>% subset(hemi == 'lh')
msc_spls.rh <- msc_spls %>% subset(hemi == 'rh')

# Get mean values for network-sulcus overlap 
msc_spls.avg <- msc_spls %>% 
  group_by(network_name, hemi, label_name) %>% 
  summarise(dice_coefficient = mean(dice_coeff))

# Rename dfs and add "ifrms.?h" column for color coding
msc_spls.avg.lh <- msc_spls.avg %>% subset(hemi == 'lh')
msc_spls.avg.lh['label_hemi']='spls.lh'

msc_spls.avg.rh <- msc_spls.avg %>% subset(hemi == 'rh')
msc_spls.avg.rh['label_hemi']='spls.rh'

# Std error calculation for plot
msc_spls.se <- msc_spls %>% 
  group_by(hemi, label_name, network_name) %>%
  summarise(n=n(), 
            sd=sd(dice_coeff), 
            se=sd/sqrt(n))

msc_spls.se.lh <- msc_spls.se %>% subset(hemi %in% c('lh')) 
msc_spls.se.rh <- msc_spls.se %>% subset(hemi %in% c('rh')) 

names(msc_spls.se.lh)[names(msc_spls.se.lh) == 'dice_coeff'] <- "se"
names(msc_spls.se.rh)[names(msc_spls.se.rh) == 'dice_coeff'] <- "se"

msc_spls.se.lh = msc_spls.se.lh %>% subset(select = -c(hemi, label_name))
msc_spls.se.rh = msc_spls.se.rh %>% subset(select = -c(hemi, label_name))

# Merge together + get upper and lower bounds
msc_spls.se.lh <- merge(msc_spls.se.lh, msc_spls.avg.lh,
                         by=c("network_name"))
msc_spls.se.rh <- merge(msc_spls.se.rh, msc_spls.avg.rh,
                         by=c("network_name"))

msc_spls.se.lh <- msc_spls.se.lh %>% 
  group_by(network_name) %>%
  mutate(upper = dice_coefficient + se, 
         lower = dice_coefficient - se)

msc_spls.se.rh <- msc_spls.se.rh %>% 
  group_by(network_name) %>%
  mutate(upper = dice_coefficient + se, 
         lower = dice_coefficient - se)

msc_spls.se.lh.u <- msc_spls.se.lh %>% subset(select = -c(lower, dice_coefficient))
names(msc_spls.se.lh.u)[names(msc_spls.se.lh.u) == 'upper'] <- "dice_coefficient"
msc_spls.se.lh.l <- msc_spls.se.lh %>% subset(select = -c(upper, dice_coefficient))
names(msc_spls.se.lh.l)[names(msc_spls.se.lh.l) == 'lower'] <- "dice_coefficient"

msc_spls.se.rh.u <- msc_spls.se.rh %>% subset(select = -c(lower, dice_coefficient))
names(msc_spls.se.rh.u)[names(msc_spls.se.rh.u) == 'upper'] <- "dice_coefficient"
msc_spls.se.rh.l <- msc_spls.se.rh %>% subset(select = -c(upper, dice_coefficient ))
names(msc_spls.se.rh.l)[names(msc_spls.se.rh.l) == 'lower'] <- "dice_coefficient"

# More renaming for plot aesthetics 
msc_spls.avg.lh$hemi <- gsub("lh", "Left Hemisphere", msc_spls.avg.lh$hemi)
msc_spls.avg.rh$hemi <- gsub("rh", "Right Hemisphere", msc_spls.avg.rh$hemi)
msc_spls.se.lh.l$hemi <- gsub("lh", "Left Hemisphere", msc_spls.se.lh.l$hemi)
msc_spls.se.lh.u$hemi <- gsub("lh", "Left Hemisphere", msc_spls.se.lh.u$hemi)
msc_spls.se.rh.l$hemi <- gsub("rh", "Right Hemisphere", msc_spls.se.rh.l$hemi)
msc_spls.se.rh.u$hemi <- gsub("rh", "Right Hemisphere", msc_spls.se.rh.u$hemi)

# Plot
network_msc.plot <- ggplot() +  
  geom_polygon(data = msc_ifrms.se.lh.l, 
               aes(x = network_name, y = dice_coefficient, 
                   group = label_hemi, 
                   color = label_hemi), 
               fill = NA,
               linetype = 2, size = .4) + 
  geom_polygon(data = msc_ifrms.se.lh.u, 
               aes(x = network_name, y = dice_coefficient, 
                   group = label_hemi, 
                   color = label_hemi), 
               fill = NA,
               linetype = 2, size = .4) +
  geom_polygon(data = msc_ifrms.avg.lh, 
               aes(x = network_name, y = dice_coefficient, 
                   fill = label_hemi, 
                   group = label_hemi, 
                   color = label_hemi
               ...
               size = .9, alpha = .3) +
  geom_point(data = msc_ifrms.avg.lh, 
             aes(x = network_name, y = dice_coefficient, 
                 color = label_hemi), 
             size = 2) + 
  
  
  geom_polygon(data = msc_ifrms.se.rh.l, 
               aes(x = network_name, y = dice_coefficient, 
                   group = label_hemi, 
                   color = label_hemi), 
               fill = NA,
               linetype = 2, size = .4) + 
  geom_polygon(data = msc_ifrms.se.rh.u, 
               aes(x = network_name, y = dice_coefficient, 
                   group = label_hemi, 
                   color = label_hemi), 
               fill = NA,
               linetype = 2, size = .4) + 
  geom_polygon(data = msc_ifrms.avg.rh, 
               aes(x = network_name, y = dice_coefficient, 
                   fill = label_hemi, group = label_hemi, color = label_hemi), 
               size =  .9, alpha = .3) +
  geom_point(data = msc_ifrms.avg.rh, 
             aes(x = network_name, y = dice_coefficient, color = label_hemi), 
             size = 2) +
  
  
  geom_polygon(data = msc_spls.se.lh.l, 
               aes(x = network_name, y = dice_coefficient, 
                   group = label_hemi, 
                   color = label_hemi), 
               fill = NA,
               linetype = 2, size = .4) + 
  geom_polygon(data = msc_spls.se.lh.u, 
               aes(x = network_name, y = dice_coefficient, 
                   group = label_hemi, 
                   color = label_hemi), 
               fill = NA,
               linetype = 2, size = .4) + 
  geom_polygon(data = msc_spls.avg.lh, 
               aes(x = network_name, y = dice_coefficient, 
                   fill = label_hemi, 
                   group = label_hemi, 
                   color = label_hemi), 
               size =  .9, alpha = .3) +
  geom_point(data = msc_spls.avg.lh, 
             aes(x = network_name, y = dice_coefficient, color = label_hemi), 
             size = 2) + 
  
  
  geom_polygon(data = msc_spls.se.rh.l, 
               aes(x = network_name, y = dice_coefficient, 
                   group = label_hemi, 
                   color = label_hemi), 
               fill = NA,
               linetype = 2, size = .4) + 
  geom_polygon(data = msc_spls.se.rh.u, 
               aes(x = network_name, y = dice_coefficient, 
                   group = label_hemi, 
                   color = label_hemi), 
               fill = NA,
               linetype = 2, size = .4) + 
  geom_polygon(data = msc_spls.avg.rh, 
               aes(x = network_name, y = dice_coefficient, 
                   fill = label_hemi, 
                   group = label_hemi, 
                   color = label_hemi), 
               size =  .9, alpha = .3) +
  geom_point(data = msc_spls.avg.rh, 
             aes(x = network_name, y = dice_coefficient, 
                 color = label_hemi), 
             size = 2) +
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0, size = 14), 
        ...
        axis.title.x = element_text(size = 0, face = "bold"), # was 12
        axis.title.y = element_text(size = 0, face = "bold"), # was 12
        axis.text.x = element_text(size = 0, face = "bold", color = "black", vjust = .50), # was 5
        axis.text.y = element_text(size = 0, face = "bold"), # was 10
        strip.text.x = element_text(size = 0, face = "bold"), # was 12
        legend.title = element_text(size=0, face = "bold"), # was 10
        legend.text = element_text(size=0), # was 8
...
# ggplot2::ggsave(filename = "~/Desktop/network_msc.plot.png",
#                 plot = network_msc.plot,
#                 device = "png",
#                 width = 8,
#                 height = 6,
#                 units = "in",
...
## Supplementary Figure 14: Individual subject fingerprints - MSC
```{r}
# Dataset
  # msc_networks
...
## label_hemi
msc_networks$label_hemi[msc_networks$label_name == "ifrms" &
                                                  msc_networks$hemi == "lh"] <- "ifrms.lh"

msc_networks$label_hemi[msc_networks$label_name == "ifrms" &
                                                  msc_networks$hemi == "rh"] <- "ifrms.rh"

msc_networks$label_hemi[msc_networks$label_name == "spls" &
                                                  msc_networks$hemi == "lh"] <- "spls.lh"

msc_networks$label_hemi[msc_networks$label_name == "spls" &
                                                  msc_networks$hemi == "rh"] <- "spls.rh"
...
## TRG_sub_hemi
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC01" &
                                                  msc_networks$hemi == "lh"] <- "MSC01.lh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC01" &
                                                  msc_networks$hemi == "rh"] <- "MSC01.rh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC02" &
                                                  msc_networks$hemi == "lh"] <- "MSC02.lh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC02" &
                                                  msc_networks$hemi == "rh"] <- "MSC02.rh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC03" &
                                                  msc_networks$hemi == "lh"] <- "MSC03.lh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC03" &
                                                  msc_networks$hemi == "rh"] <- "MSC03.rh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC04" &
                                                  msc_networks$hemi == "lh"] <- "MSC04.lh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC04" &
                                                  msc_networks$hemi == "rh"] <- "MSC04.rh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC05" &
                                                  msc_networks$hemi == "lh"] <- "MSC05.lh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC05" &
                                                  msc_networks$hemi == "rh"] <- "MSC05.rh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC06" &
                                                  msc_networks$hemi == "lh"] <- "MSC06.lh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC06" &
                                                  msc_networks$hemi == "rh"] <- "MSC06.rh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC07" &
                                                  msc_networks$hemi == "lh"] <- "MSC07.lh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC07" &
                                                  msc_networks$hemi == "rh"] <- "MSC07.rh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC08" &
                                                  msc_networks$hemi == "lh"] <- "MSC08.lh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC08" &
                                                  msc_networks$hemi == "rh"] <- "MSC08.rh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC09" &
                                                  msc_networks$hemi == "lh"] <- "MSC09.lh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC09" &
                                                  msc_networks$hemi == "rh"] <- "MSC09.rh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC10" &
                                                  msc_networks$hemi == "lh"] <- "MSC10.lh"
msc_networks$TRG_sub_hemi[msc_networks$TRG_sub == "sub-MSC10" &
                                                  msc_networks$hemi == "rh"] <- "MSC10.rh"
# Plot
all_conn_fp_msc.plot <- ggplot() +  
  geom_polygon(data = msc_networks, 
               aes(x = network_name, y = dice_coeff, fill = label_hemi, group = label_hemi, color = label_hemi), 
               size = .5, alpha = .3) +
  geom_point(data = msc_networks, 
             aes(x = network_name, y = dice_coeff, color = label_hemi), 
                                         size = 1, alpha = 1) + 
  coord_radar(start = -pi/2) +
  labs(x = "Network Name",
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0, size = 14), 
        ...
        axis.title.x = element_text(size = 0),
        axis.title.y = element_text(size = 0),
        axis.text.x = element_text(size = 0, face = "bold", color = "black", vjust = .50), # was 4
        axis.text.y = element_text(size = 0, face = "bold"),
        strip.text.y = element_text(size = 0),
        strip.text.x = element_text(size = 0, face = "bold"), # was 12
        legend.title = element_text(size=0), # was 12
        legend.text = element_text(size=0), # was 12
        legend.position = "bottom",
        axis.line = element_line(colour = "black", 
                                 size = 0, linetype = "solid", lineend = "round"),
  ...
  guides(fill = "none", color = "none") + 
  ylim(0,1) + 
  facet_wrap(~TRG_sub_hemi, ncol = 6)
#all_conn_fp_msc.plot #unmark to view

ggplot2::ggsave(filename = "~/Desktop/all_conn_fp_msc_plot.png",
                plot = all_conn_fp_msc.plot,
                device = "png",
                width = 8.5,
                height = 5.5,
                units = "in",
...
## Supplementary Figure 18: Correlation matrices for sulcal intersections of the discovery and replication sample shallow PCC sulci
```{r}
## Making matrices
# All HCP together
...
## Supplementary Figure 20a: Raw sulcal depth (mm)
...
## Supplemental Figure 20b: Raw cortical thickness 
...
## Supplemental Figure 22a: Depth of all PMC sulci between age groups (humans)
...
## Supplemental Figure 22b: Surface area of all PCC and PRC sulci between age groups (humans)
...
## Supplemental Figure 22c: Cortical thickness of all PMC sulci in juveniles
...
# Supplementary Figure 23: *ifrms* classification based on morphology
```{r}
library(factoextra)
library(cluster)
library(plotly)
# ifrms classification based on morph 
# ifrms_compdev_morphology <- read.csv("~/Desktop/DropBox/cnl/stable_projects/TripartiteLandmark_PosteriorCingulate/RMD_csvs/ifrms_compdev_morphology.csv")

ifrms_compdev_morphology <- ifrms_compdev_morphology %>% mutate(spec_grp = case_when(dataset %in% 
                                                                                       c("young_adult_chimp", 
                                                                                         "older_adult_chimp", "young_chimp") ~ 
                                                                                       "chimp",
                                                                                     dataset == "HCP" ~ "young_adult_human",
                                                                                     dataset == "NORA" ~ "juvenile_human",
                                                                                     dataset == "ADNI" ~ "older_adult_human"))

classification.plot <- ggplot(data = ifrms_compdev_morphology, aes(x = sulcal_depth_mm, y = total_surface_area_.mm.2.)) +
  geom_point(aes(fill = spec_grp), alpha = .8, shape = 21, color = 'black',
              position=position_jitterdodge(jitter.width = .3, dodge.width = .9, jitter.height = 0)) +
  plot_theme +
...
classification.plot <- ggplot(data = ifrms_compdev_morphology, aes(x = sulcal_depth_mm, y = total_surface_area_.mm.2.)) +
  geom_jitter(aes(fill = species), alpha = .8, shape = 21, color = 'black',
              position=position_jitterdodge(jitter.width = .3, dodge.width = .9, jitter.height = 0)) +
  plot_theme +
...
# left hemisphere
ifrms_compdev_morphology_lh <- ifrms_compdev_morphology %>% subset(hemi == "lh") 
df.lh <- ifrms_compdev_morphology_lh %>%
  select(sulcal_depth_mm, total_surface_area_.mm.2.)

ggscatter(df.lh, x = "sulcal_depth_mm", y = "total_surface_area_.mm.2.", 
                                    size = 2
                                    )

df.lh.s <- df.lh %>% mutate(scale_depth = scale(sulcal_depth_mm),
                            scale_sa = scale(total_surface_area_.mm.2.)) %>% select(-c(1:2))

# Determine best # of clusters
NbClust(df.lh.s, distance = "euclidean", method = "kmeans", index ="all") 

# cluster based on optimal # of clusters = 2
set.seed(1)
km.lh <- kmeans(df.lh.s, centers = 2, nstart = 25)


clust.lh <- km.lh$cluster %>%
  as.factor()
df.lh.s <- df.lh.s %>%
  mutate(groups = clust.lh)

tbl.clust.lh <- table(df.lh.s$groups)

df.lh.plt <- cbind(df.lh.s, ifrms_compdev_morphology_lh)

# left plot with humans
classification.plot <- ggscatter(df.lh.plt, x = "sulcal_depth_mm", y = "total_surface_area_.mm.2.", 
                        size = 2,
                        shape = 21,
                        #color = "groups",
                        fill = "groups",
  ...
  scale_fill_manual(breaks = c("2", "1"),
                    values = c("blue", "red")) + 
  scale_color_manual(breaks = c("2", "1"),
                     values = c("blue", "red")) 
ggplotly(classification.plot)



classification.plot_lh <- classification.plot +
  new_scale_fill() + 
  geom_point(aes(fill = group), label = df.lh$group, check_overlap = F, size = 1.5, shape = 21) +
    scale_fill_manual(breaks = c("juvenile", "young-adult", "older-adult"),
                      values = c("#e41a1c", "#377eb8", "#006837"))

# left with chimps 
chimp_lh <- ifrms_compdev_morphology %>% 
  subset(hemi == "lh" & species == "chimpanzee") %>% 
  select(sulcal_depth_mm, total_surface_area_.mm.2.)

classification_plot_lh.final <- classification.plot_lh + 
  geom_point(data = chimp_lh, fill = 'black', shape = 21, size = 2) + 
  geom_point(aes(x=2.709024, y=60.82028), size = 4, shape = 21, fill ="red") +
  guides(fill = "none", color = "none") +
...
classification_plot_lh.final
#ggsave(filename = "~/Desktop/classification_plot_lh_final.png",
#                         plot = classification_plot_lh.final,
#                         device = "png",
#                         width = 6,
#                         height = 6, 
#                         units = "in",
...
# right hemisphere
ifrms_compdev_morphology_rh <- ifrms_compdev_morphology %>% subset(hemi == "rh")

df.rh <- ifrms_compdev_morphology_rh %>%
  select(sulcal_depth_mm, total_surface_area_.mm.2.)

ggscatter(df.rh, x = "sulcal_depth_mm", y = "total_surface_area_.mm.2.", 
          size = 2
)

df.rh.s <- df.rh %>% mutate(scale_depth = scale(sulcal_depth_mm),
                            scale_sa = scale(total_surface_area_.mm.2.)) %>% 
                     select(-c(1:2))
# Determine best # of clusters
NbClust(df.rh.s, distance = "euclidean", method = "kmeans", index ="all") 

# cluster based on optimal # of clusters = 2
set.seed(1)
km.rh <- kmeans(df.rh.s, centers = 2, nstart = 25)

clust.rh <- km.rh$cluster %>%
  as.factor()
df.rh.s <- df.rh.s %>%
  mutate(groups = clust.rh)

tbl.clust.rh <- table(df.rh.s$groups)



df.rh.plt <- cbind(df.rh.s, ifrms_compdev_morphology_rh)

# right plot with humans
classification.plot.rh <- ggscatter(df.rh.plt, x = "sulcal_depth_mm", y = "total_surface_area_.mm.2.", 
                                 size = 2,
                                 shape = 21,
                                 #color = "groups",
                                 fill = "groups",
...
classification.plot.rh2 <- classification.plot.rh + new_scale_fill() + 
geom_point(aes(fill = group), label = df.rh$group, check_overlap = F, size = 1.5, shape = 21) +
scale_fill_manual(breaks = c("juvenile", "young-adult", "older-adult"),
                  values = c("#e41a1c", "#377eb8", "#006837"))

# right with chimps
chimp_rh <- ifrms_compdev_morphology %>% 
  subset(hemi == "rh" & species == "chimpanzee") %>% 
  select(sulcal_depth_mm, total_surface_area_.mm.2.)

classification_plot_rh.final <- classification.plot.rh2 + 
  geom_point(data = chimp_rh, fill = 'black', shape = 21, size = 2) + 
  geom_point(aes(x=1.752122, y=56.87245), size = 4, shape = 21, fill ="red") +
  guides(fill = "none", color = "none") +
  scale_y_continuous(breaks=seq(0, 350, 50), limits = c(0,350)) +
  scale_x_continuous(breaks=seq(0, 15, 3), limits = c(0,15)) +
  theme(plot.title = element_text(face = "bold", hjust = 0, size = 14), 
...
classification_plot_rh.final
#ggsave(filename = "~/Desktop/classification_plot_rh_final.png",
#       plot = classification_plot_rh.final,
#       device = "png",
#       width = 6,
#       height = 6, 
#       units = "in",
...
## Supplemental Figure 24: Evaluation of the spherical CNNs ability to define PMC sulci 
```{r, warning = FALSE}
# Features for plot
...
cnn_all.plot <- ggplot() +
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0, size = 14), 
          ...
          axis.title.y = element_text(size=20, face = "bold", vjust = .9),
          axis.title.y.right = element_text(size=20, face = "bold", vjust = 1),
          axis.text.x = element_text(size = 16, face = "bold", vjust = .70), # was 12 
          axis.text.y = element_text(size = 20, face = "bold"), # was 16
          legend.title = element_text(size=14), 
          legend.text = element_text(size=12),
          strip.text.x = element_text(size = 18, face = "bold"), # was 12
          strip.background = element_blank(),
          strip.placement = "outside",
          axis.line = element_line(colour = "black", linetype = "solid", lineend = "round")) +
  facet_grid(. ~ type, 
...
# ggplot2::ggsave(filename = "~/Desktop/cnn_all_plot.png",
#                 plot = cnn_all.plot,
#                 device = "png",
#                 width = 10,
#                 height = 5,
