...
SUBJECT_LIST= ../subjectLists/chimp_list.txt

SUBJECTS=$(cat $SUBJECT_LIST)

SUBJECTS_DIR= /home/weiner/NH_Primates/

PROJECT_DIR=

### DIRECTORY WITH FSAVERAGE PROJECTED LABELS FOR TARGET SUBJECTS
...
echo ${SUB_ID}
cd /home/weiner/reyansh/chimp_LPC;
