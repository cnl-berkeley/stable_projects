...
parietal_label_names = np.array(['csts-1', 'csts-2', 'csts-3', 'aipsj', 'smgs', 'slos-v', 'slos-d'])
...
for i, middle_frontal_label in enumerate(middle_frontal_label_names):
    ...
    for sub in subjects:
        try:
            ...
            label_path_lh = prediction_fsaverage_space_labels + '/lh.{}_{}.label'.format(sub, middle_frontal_label)
    ...
    for sub in subjects:
        try:
            label_path_rh = prediction_fsaverage_space_labels + '/rh.{}_{}.label'.format(sub ,middle_frontal_label)
...
vertices_lh, RAS_lh = read_label('/home/weiner/NH_Primates/chimp_data/ncAverage30/label/lh.cortex.label')
...
vertices_rh, RAS_rh = read_label('/home/weiner/NH_Primates/chimp_data/ncAverage30/label/rh.cortex.label')
